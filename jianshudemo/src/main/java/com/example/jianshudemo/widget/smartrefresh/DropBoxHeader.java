package com.example.jianshudemo.widget.smartrefresh;
...
import com.example.jianshudemo.widget.PathsDrawable;
...
public class DropBoxHeader extends SimpleComponent implements RefreshHeader {
    ...
    public DropBoxHeader(Context context, AttributeSet attrs) {
...
//            drawable3.printOriginal("drawable3");
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        canvas.drawPath(generateCoverPath(body), mPaint);
    ...
    @NonNull
    protected Path generateCoverPath(BoxBody body) {
        mPath.reset();
